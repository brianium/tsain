...
```bash
clj-nrepl-eval -p 7888 "(require '[ascolais.sandestin :as sandestin] :reload)"
```

Then call functions from it:

```bash
clj-nrepl-eval -p 7888 "(sandestin/some-function arg1 arg2)"
```
...
```bash
clj-nrepl-eval -p 7888 "(require '[ascolais.sandestin] :reload)"
```
...
clj-nrepl-eval -p 7888 "(require '[ascolais.sandestin-test] :reload)"
clj-nrepl-eval -p 7888 "(run-tests 'ascolais.sandestin-test)"
```
